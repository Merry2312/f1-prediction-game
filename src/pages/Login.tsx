    ...
    >
      <div className="w-full max-w-[420px]">
        <div className="bg-f1-panel border border-f1-border rounded-xl p-12">
          ...
          <p className="text-f1-muted text-[13px] mb-9">Sign in to compete with your mates</p>
          ...
          <p className="text-center mt-5 text-[13px] text-f1-muted">
            ...
            <Link to="/register" className="text-f1-red font-semibold hover:brightness-110">
              Create one
            </Link>
          </p>
        </div>
